...
var FieldSetControl = /** @class */ (function (_super) {
    ...
    FieldSetControl.prototype.render = function () {
        ...
        return (react_1.default.createElement(Collapse_1.default, tslib_1.__assign({}, rest, { body: body, className: className, children: this.renderBody, wrapperComponent: "fieldset", headingComponent: "legend" })));
    };
